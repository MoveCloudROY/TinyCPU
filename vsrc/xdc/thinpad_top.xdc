...
#		other_o ...........X_____________________X_____________________X
#							 __________
#		we      ____________|          |____
#
...
set_input_delay $ram_input_delay -clock $cpu_clk -max [get_ports ext_ram_data[*]] 


set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports base_ram_addr[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports base_ram_be_n[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports base_ram_data[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports base_ram_oe_n] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports ext_ram_addr[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports ext_ram_be_n[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports ext_ram_data[*]] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports ext_ram_oe_n] 
set_output_delay $ram_output_setup -clock $cpu_clk -max [get_ports ext_ram_ce_n] 

set_output_delay $ram_we_output_setup -clock $cpu_clk -max [get_ports base_ram_we_n] 
set_output_delay $ram_we_output_setup -clock $cpu_clk -max [get_ports ext_ram_we_n] 
set_output_delay $ram_we_output_hold -clock $cpu_clk -min [get_ports base_ram_we_n] 
set_output_delay $ram_we_output_hold -clock $cpu_clk -min [get_ports ext_ram_we_n] 